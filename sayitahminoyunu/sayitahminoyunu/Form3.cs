...
namespace sayitahminoyunu
{
    public partial class Form3 : Form
    {
        ...
        private void btnTahmin_Click(object sender, EventArgs e)
        {
            ...
            if (tahminStr.Length != 4 || !int.TryParse(tahminStr, out int tahmin))
            {
                MessageBox.Show("Lütfen 4 basamaklı bir sayı gir!");
                return;
            }
            ...
            {
                // puan hesap
                int kazanilanPuan = ((kalanHak * 100) * 2);
        ...
        private void yenioyunbaslat()
        {
            ...
            tutulansayi = rnd.Next(1000, 10000);
